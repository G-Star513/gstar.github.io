...
<head>
    ...
    <title>Home</title>
    <link rel="stylesheet" type="text/css" href="logoimg/0.css">
    <link rel="stylesheet" type="text/css" href="logoimg/lightbox.min.css">
    <script type="text/javascript" src="logoimg/lightbox-plus-jquery.min.js"></script>
